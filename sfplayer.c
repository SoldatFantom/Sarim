...
void display_help() {
       printf("Usage: SF_player [OPTION] [FILE or DIRECTORY]\n");
    ...
    printf("Examples:\n");
    printf("  SF_player --dir /path/to/music           Play all .mp3, .wav, and .ogg files in the specified directory.\n");
    printf("  SF_player --nopath --dir /path/to/music  Same as above but suppress the display of file paths during playback.\n");
    printf("  SF_player my_playlist.m3u                Play the .mp3, .wav, and .ogg files listed in the M3U playlist.\n");
    printf("  SF_player song.mp3                       Play the specified .mp3 file.\n");
    printf("  SF_player sound.wav                      Play the specified .wav file.\n");
    printf("  SF_player track.ogg                      Play the specified .ogg file.\n");
    printf("  SF_player --nopath song.mp3              Play the specified .mp3 file but suppress the file path display.\n\n");
...
void display_ihelp() {
    ...
    printw("Usage: SF_player [OPTION] [FILE or DIRECTORY]\n");
    ...
    printw("Examples:\n");
    printw("  SF_player --dir /path/to/music           Play all .mp3, .wav, and .ogg files in the specified directory.\n");
    printw("  SF_player --nopath --dir /path/to/music  Same as above but suppress the display of file paths during playback.\n");
    printw("  SF_player my_playlist.m3u                Play the .mp3, .wav, and .ogg files listed in the M3U playlist.\n");
    printw("  SF_player song.mp3                       Play the specified .mp3 file.\n");
    printw("  SF_player sound.wav                      Play the specified .wav file.\n");
    printw("  SF_player track.ogg                      Play the specified .ogg file.\n");
    printw("  SF_player --nopath song.mp3              Play the specified .mp3 file but suppress the file path display.\n\n");
