...
void display_help() {
       printf("Usage: d_player [OPTION] [FILE or DIRECTORY]\n");
    ...
    printf("Examples:\n");
    printf("  d_player --dir /path/to/music           Play all .mp3, .wav, and .ogg files in the specified directory.\n");
    printf("  d_player --nopath --dir /path/to/music  Same as above but suppress the display of file paths during playback.\n");
    printf("  d_player my_playlist.m3u                Play the .mp3, .wav, and .ogg files listed in the M3U playlist.\n");
    printf("  d_player song.mp3                       Play the specified .mp3 file.\n");
    printf("  d_player sound.wav                      Play the specified .wav file.\n");
    printf("  d_player track.ogg                      Play the specified .ogg file.\n");
    printf("  d_player --nopath song.mp3              Play the specified .mp3 file but suppress the file path display.\n\n");
...
void display_ihelp() {
  printw("Usage: d_player [OPTION] [FILE or DIRECTORY]\n");
    ...
    printw("Examples:\n");
    printw("  d_player --dir /path/to/music           Play all .mp3, .wav, and .ogg files in the specified directory.\n");
    printw("  d_player --nopath --dir /path/to/music  Same as above but suppress the display of file paths during playback.\n");
    printw("  d_player my_playlist.m3u                Play the .mp3, .wav, and .ogg files listed in the M3U playlist.\n");
    printw("  d_player song.mp3                       Play the specified .mp3 file.\n");
    printw("  d_player sound.wav                      Play the specified .wav file.\n");
    printw("  d_player track.ogg                      Play the specified .ogg file.\n");
    printw("  d_player --nopath song.mp3              Play the specified .mp3 file but suppress the file path display.\n\n");
